...
import { User, Mail, Lock, Camera, Edit3, Save, X, Eye, EyeOff, Building, MapPin } from 'lucide-react';
                  ...
                  <div>
                    {isEditing ? (
                      ...
                      <div className="flex items-center justify-center space-x-3">
                        ...
                        <span className="text-lg font-medium text-gray-900">{profileData.company}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div>
                    {isEditing ? (
                      <textarea
                        ...
                        className="w-full px-4 py-3 text-center border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 resize-none"
                      ...
                      <div className="flex items-center justify-center space-x-3">
                        ...
                        <span className="text-lg font-medium text-gray-900">{profileData.address}</span>
                      </div>
                    )}
                  </div>
                </div>
             ...
             <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100">
               ...
               <div className="space-y-4">
                 ...
                 <div className="flex items-center justify-between py-3 border-b border-gray-100">
                   ...
                   <span className="text-sm font-semibold text-gray-900">January 2024</span>
                 </div>
                 <div className="flex items-center justify-between py-3 border-b border-gray-100">
