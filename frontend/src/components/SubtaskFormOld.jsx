  ...
  if (isDialogMode) {
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-white rounded-2xl shadow-lg border border-gray-100" onClose={onClose}>
          <DialogHeader className="pb-6 bg-gradient-to-r from-primary/5 to-primary/10 rounded-t-2xl -m-6 mb-0 p-6">
