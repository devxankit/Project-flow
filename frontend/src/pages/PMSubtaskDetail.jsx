...
const PMSubtaskDetail = () => {
  ...
  useEffect(() => {
    console.log('PMSubtaskDetail - Parameters:', { id, taskId, customerId });
    
    if (id && taskId && customerId && customerId !== 'undefined' && customerId !== 'null') {
      loadSubtask();
    } else {
      console.error('Missing or invalid required parameters:', { id, taskId, customerId });
      toast.error('Error', 'Missing or invalid subtask, task, or customer ID');
      navigate('/tasks');
    }
